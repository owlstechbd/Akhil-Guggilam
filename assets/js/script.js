...
(function ($) {
    ...
    $(window).on('load', function () {
        ...
        let index = 0;
        const delay = 3000; // how long each stays visible (ms)


        function showNextRole() {
            // remove active from previous
            roles.forEach((r, i) => r.classList.remove('active'));
            // add to current
        ...
        showNextRole();
        setInterval(showNextRole, delay);
  ...
  const skillSections = document.querySelectorAll(".skill-items-wrap");
